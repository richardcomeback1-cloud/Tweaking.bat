...
set "g=%ESC%[92m"    :: Bright green
set "y=%ESC%[93m"    :: Bright yellow
set "r=%ESC%[91m"    :: Bright red
set "w=%ESC%[97m"    :: Bright white
set "b=%ESC%[94m"    :: Bright blue
set "p=%ESC%[95m"    :: Bright magenta
set "reset=%ESC%[0m" :: Reset color
...
if %errorlevel% neq 0 (
echo                Run Kiwis Free Utility as Admin%
powershell -NoProfile -NonInteractive -Command start -verb runas "'%~s0'" >nul 2>&1
if !errorlevel! equ 0 exit /b
echo.
echo             The Utility is not running as Admin!
...
echo.
echo.
echo %w%I am not responsible for any problems/Damages with your pc this may cause, MAKE A RESTORE POINT 
echo.
echo %w%Any distribution, resseling etc is NOT tolerated.
echo.
